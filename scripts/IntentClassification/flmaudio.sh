...
python -m torch.distributed.launch --nproc_per_node=4  --master_port=29501 run_downstream.py \
-m train \
-u flmaudio \
...
-g /share/project/lx/projects/NativeAudio-trainer-ddp/audio_models/config_mini.json \
-d fluent_commands \
-n flmaudio__IC_c150000_bs64 \
-o config.downstream_expert.datarc.train_batch_size=32,,config.runner.gradient_accumulate_steps=1
